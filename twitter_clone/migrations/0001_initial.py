    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('following', models.ManyToManyField(related_name='_twitteruser_following_+', to='twitter_clone.TwitterUser')),
                ('follows', models.ManyToManyField(related_name='_twitteruser_follows_+', to='twitter_clone.TwitterUser')),
